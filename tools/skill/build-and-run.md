...
2. 启动全流程：`bash tools/scripts/start.sh`
3. 访问后台：`http://127.0.0.1:8787/admin`
4. 验证状态：`bash tools/scripts/status.sh`

## 可选模式

- 跳过种子：`bash tools/scripts/start.sh --no-seed`
- 不启后台：`bash tools/scripts/start.sh --no-admin`
